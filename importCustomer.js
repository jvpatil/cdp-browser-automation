...
const createSourceObjectAndUploadSample=async()=>{
  ...
  const csvContent=`sourcecustomerid,email,mobilephone,firstname,lastname,gender,birthdate,jobtitle
1,jagan.test01@yahoo.com,16504522260,Sachin,Tendulkar,M,07/10/26,Sales Executive
`;
  ...
  if(typeof window.runCdpCustomerFieldMapping!=="function"){
    throw new Error("cdpCustomerFieldMapping.js was not loaded.");
  }

  await window.runCdpCustomerFieldMapping();
};
